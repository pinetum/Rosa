...
class Gnuplot
{
    ...
    Gnuplot& savepng(const std::string &filename = "gnuplot_output");
...
std::string Gnuplot::m_sGNUPlotPath = "/opt/local/bin/";
#endif
...
//
Gnuplot& Gnuplot::savepng(const std::string &filename)
{
	
	cmd("set terminal pngcairo size 640,480 enhanced font 'Verdana,10'");
